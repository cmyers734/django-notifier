...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BackendConfiguration'
        db.create_table(u'notifier_backendconfiguration', (
            ...
            ('notify_mandatory', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('notify_default', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'notifier', ['BackendConfiguration'])

        # Adding unique constraint on 'BackendConfiguration', fields ['backend', 'notification']
        db.create_unique(u'notifier_backendconfiguration', ['backend_id', 'notification_id'])

        # Adding field 'Notification.description'
        db.add_column(u'notifier_notification', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'BackendConfiguration', fields ['backend', 'notification']
        db.delete_unique(u'notifier_backendconfiguration', ['backend_id', 'notification_id'])

        # Deleting model 'BackendConfiguration'
        db.delete_table(u'notifier_backendconfiguration')

        # Deleting field 'Notification.description'
        db.delete_column(u'notifier_notification', 'description')
    ...
    models = {
        ...
        u'notifier.backendconfiguration': {
            'Meta': {'unique_together': "(('backend', 'notification'),)", 'object_name': 'BackendConfiguration'},
            ...
            'notify_default': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'notify_mandatory': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'db_index': 'True'})
        },
